...
export const sendOTPEmail = async (email: string, otp: string): Promise<void> => {
  const fromAddress = smtp.from;
  const subject = "Digital Notice Board - Password Reset OTP";
  ...
  const html = `
    ...
    <body>
        <div class="wrapper">
            <div class="container">
                <div class="header">
                    <h1 style="margin: 0; font-size: 24px;">DIGITAL NOTICE BOARD</h1>
                </div>
                <div class="content">
                    <div class="message">
                    ...
                    <div class="credentials-card">
                        <span style="font-size: 13px; text-transform: uppercase; color: #64748b;">Your OTP</span>
                        <div class="password">${otp}</div>
                    </div>
     
                    <div style="margin-top: 32px; color: #64748b; font-size: 14px; text-align: center;">
                        This OTP is valid for ${config.otpExpiryMinutes} minutes. Do not share it with anyone.
                    </div>
                </div>
                <div class="footer">
                    <p>This is an automated message from the Digital Notice Board System.</p>
  ...
  try {
    await transporter.sendMail({
      ...
      subject: subject,
      html: html,
      text: `Your password reset OTP is: ${otp}\nThis is valid for ${config.otpExpiryMinutes} minutes.`,
    });
...
export default { sendWelcomeInvite, sendOTPEmail };
